# `miniaudio_jll.jl` (v0.11.25+0)

[![deps](https://juliahub.com/docs/miniaudio_jll/deps.svg)](https://juliahub.com/ui/Packages/General/miniaudio_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/44964791762581b921063610b97a6948088ef6e0/M/miniaudio/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `miniaudio_jll.jl` have been built from these sources:

* git repository: https://github.com/mackron/miniaudio.git (revision: `9634bedb5b5a2ca38c1ee7108a9358a4e233f14d`)

## Platforms

`miniaudio_jll.jl` is available for the following platforms:
